...
● private-tmp-test.service - PrivateTmp test
   Loaded: loaded (/etc/systemd/system/multi-user.target.wants/private-tmp-test.
service; bad; vendor preset: enabled)
   Active: active (running) since Mon 2019-05-27 11:11:34 UTC; 3min 1
5s ago
 Main PID: 38 (bash)
   CGroup: /docker/3309928532f1a8bf6859741e798adff74717641fb007fc00c3688ed33c205
ef6/system.slice/private-tmp-test.service
